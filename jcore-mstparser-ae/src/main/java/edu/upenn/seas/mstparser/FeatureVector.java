 ...
 *
 * <p>
 * Also, in order to avoid copies, the second of these internal <tt>FeatureVector</tt> instances can be negated, so that
 * it has the effect of subtracting any values rather than adding them.
 *
 * <p>
 ...
 * @see edu.upenn.seas.mstparser.Feature
 */
