...
public class DependencyDecoder {
    ...
    public Object[][] decodeNonProjective(DependencyInstance inst, FeatureVector[][][] fvs, double[][][] probs,
        ...
        TIntIntHashMap final_edges = chuLiuEdmonds(scoreMatrix, curr_nodes, oldI, oldO, false, new TIntIntHashMap(),
                reps);
    ...
    private static TIntIntHashMap chuLiuEdmonds(double[][] scoreMatrix, boolean[] curr_nodes, int[][] oldI,
            int[][] oldO, boolean print, TIntIntHashMap final_edges, TIntIntHashMap[] reps) {
