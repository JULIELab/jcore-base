...
public class XmiDBMultiplierReader extends DBMultiplierReader {
    ...
    public void initialize(UimaContext context) throws ResourceInitializationException {
        ...
        if (additionalTables != null) {
            ...
            try {
                DataBaseConnector dbc = new DataBaseConnector(costosysConfigPath);
                ...
                getMetaData().getConfigurationParameterSettings().setParameterValue(SubsetReaderConstants.PARAM_ADDITIONAL_TABLE_SCHEMAS, additionalTableSchemas);

            } catch (FileNotFoundException e) {
                // don't do anything; if there is a problem, we let the superclass throw the error
            }
        }
