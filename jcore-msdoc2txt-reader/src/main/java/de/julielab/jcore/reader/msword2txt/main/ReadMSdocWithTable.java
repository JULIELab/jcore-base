 ...
 *  * read a file, can recognize tables and write a table structure by | and 4 space characters
 *  * for using text with the brat rapid annotation tool
 *  
 * readDocFileTableAndTransform2Text()
 *	* read a file, can recognize tables and remove the table structure 
 *
 * readDocFileAndTransform2HTMLtable()
 *  * read a file, can recognize tables and write a table structure by the HTML-code <table>...</table>
 *  
