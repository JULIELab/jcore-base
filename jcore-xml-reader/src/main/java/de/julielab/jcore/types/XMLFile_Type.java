 ...
 * @generated */
public class XMLFile_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = XMLFile.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.XMLFile");
  ...
  public String getFileToRead(int addr) {
      ...
      jcas.throwFeatMissing("fileToRead", "de.julielab.jcore.types.XMLFile");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public XMLFile_Type(JCas jcas, Type casType) {
    super(jcas, casType);
