...
public class FileReaderTest extends TestCase {
     ...
     * Object to be tested
     */
    private CollectionReader fileReader;
    ...
    protected void setUp() throws Exception {
        ...
        fileReader = getCollectionReader(DESC_FILE_READER);
    ...
    public void testDocumentTextPresent() throws CASException {
     ...
     */
    private void writeArtifact(String artifact) {
