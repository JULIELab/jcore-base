...
public class EventConsumer extends JCasAnnotator_ImplBase {
    ...
    public void process(JCas aJCas) throws AnalysisEngineProcessException {
        ...
        try {
            if (!bioEventServiceMode) {
                ...
                EventWriter eventWriter = createEventWriter(documentText, a2File);
                Iterator eventIterator = cas.getAnnotationIndex(eventType).iterator();
                int i = 1;
                while (eventIterator.hasNext()) {
                    EventMention eventMention = (EventMention) eventIterator.next();
    ...
    private EventWriter createEventWriter(String documentText, String id) throws AnalysisEngineProcessException {
        ...
        try {
            ...
            return new EventWriter(eventFileWriter, proteinWriter, triggerWriter, entityWriter);
        } catch (IOException e) {
            throw new AnalysisEngineProcessException(e);
        }
    }
