...
public class BioSemEventAnnotator extends JCasAnnotator_ImplBase {
     ...
     * @param bioSemArg
     *            The BioSem-object of the argument, i.e. a <tt>Word</tt> when the argument is a protein or a
     *            <tt>PData</tt> if the argument is another event
     * @param argPos
     *            The position of the argument, 1 (Theme) or 2 (Theme2 when the argument is a protein and it's a Binding
     *            event, Cause otherwise)
     * @param proteinMap
     * @param triggerAnnotations
     * @param eventAnnotations2
     * @param triggerMap
     * @param aJCas
     *            The CAS to connect the new <tt>ArgumentMention</tt> annotation with
     ...
     *         <li><em>Theme2</em> when it's the second argument and it's a protein (actually: when the argument is not
     *         another <tt>EventMention</tt>) and the event type is "Binding"</li>
    ...
    /**
     * Assigns an ID of the form <tt>Ti</tt> to each gene in the CAS, <tt>i</tt> being an enumeration number beginning
     * at 0.
     *
     * @param aJCas
     * @return
