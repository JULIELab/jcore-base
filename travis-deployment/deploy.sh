...
if [ "$TRAVIS_PULL_REQUEST" == 'false' ]; then
	...
	if [ ! -f julielab-maven-aether-utilities.jar ]; then
    	    wget https://oss.sonatype.org/content/repositories/snapshots/de/julielab/julielab-maven-aether-utilities/1.0.0-SNAPSHOT/julielab-maven-aether-utilities-1.0.0-20181220.151242-1-cli-assembly.jar --output-document julielab-maven-aether-utilities.jar
    fi
