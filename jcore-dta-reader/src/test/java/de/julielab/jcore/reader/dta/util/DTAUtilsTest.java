...
public class DTAUtilsTest {
    ...
    public void testSlidingSymetricWindow() throws Exception {
        ...
        expected.add(Arrays.asList("Alte deutsche Lieder gesammelt von L. A. v. Arnim und Clemens Brentano .".split(" ")));
        assertEquals(expected, 
        	DTAUtils.slidingSymetricWindow(jcas, 6));
        assertEquals(4, 
            	DTAUtils.slidingSymetricWindow(jcas, 5).size());
    }
